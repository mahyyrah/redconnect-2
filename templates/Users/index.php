...
<div class="dashboard-wrapper">
    ...
    <aside class="sidebar">
        ...
        <?= $this->Html->link('👤 Users', ['controller' => 'Users', 'action' => 'index'], ['class' => 'active']) ?>
    ...
    <main class="main-content">
        ...
        <div class="topbar d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
            <div>
                ...
                <p class="text-muted mb-0">Manage login accounts and system roles.</p>
            </div>
        ...
        <div class="page-card">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
                <div>
                    <h2 class="page-title mb-1">👤 User List</h2>
                    <p class="text-muted page-subtitle mb-0">All registered system users in RedConnect.</p>
                </div>

                <?= $this->Html->link('+ Add User', ['action' => 'add'], ['class' => 'btn-red']) ?>
            </div>
                ...
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($users as $user): ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                <td class="fw-semibold"><?= h($user->email) ?></td>
                                <td>
                                ...
                                <td class="text-center">
                                    <?= $this->Html->link('View', ['action' => 'view', $user->id], ['class' => 'action-link view-btn']) ?>
                                    <?= $this->Html->link('Edit', ['action' => 'edit', $user->id], ['class' => 'action-link edit-btn']) ?>
