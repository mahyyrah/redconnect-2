...
<div class="dashboard-wrapper">
    <aside class="sidebar">
        ...
        <?= $this->Html->link('🅾️ Blood Types', ['controller'=>'BloodTypes','action'=>'index'], ['class'=>'active']) ?>
    ...
    <main class="main-content">
        <div class="topbar d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
            <div>
                <h4 class="mb-1">Blood Type Management</h4>
                <p class="text-muted mb-0">Manage blood group categories used by donors.</p>
            </div>
        ...
        <div class="page-card">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
                <div>
                    <h2 class="page-title mb-1">🅾️ Blood Type List</h2>
                    <p class="text-muted page-subtitle mb-0">All blood group categories in RedConnect.</p>
                </div>

                <?= $this->Html->link('+ Add Blood Type', ['action'=>'add'], ['class'=>'btn-red']) ?>
            </div>
                ...
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($bloodTypes as $bloodType): ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><span class="blood-badge"><?= h($bloodType->blood_group) ?></span></td>
                                <td class="text-center">
                                    <?= $this->Html->link('View', ['action'=>'view',$bloodType->id], ['class'=>'action-link view-btn']) ?>
                                    <?= $this->Html->link('Edit', ['action'=>'edit',$bloodType->id], ['class'=>'action-link edit-btn']) ?>
                                    <?= $this->Form->postLink('Delete', ['action'=>'delete',$bloodType->id], [
                                        'method'=>'delete',
                                        'confirm'=>__('Are you sure you want to delete # {0}?',$bloodType->id),
                        ...
                        <?php if ($bloodTypes->count() == 0): ?>
                            <tr>
                                <td colspan="3" class="text-center text-muted py-4">No blood type records found.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
