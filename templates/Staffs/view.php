...
<div class="container py-5">
    ...
    <div class="view-card">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
            <div>
                <h2 class="page-title mb-1">🧑‍⚕️ Staff Details</h2>
                <p class="text-muted mb-0">View staff profile and related donation records.</p>
            </div>

            <div class="d-flex gap-2">
                <?= $this->Html->link('← Back', ['action'=>'index'], ['class'=>'btn btn-outline-secondary']) ?>
                <?= $this->Html->link('Edit Staff', ['action'=>'edit', $staff->id], ['class'=>'btn-red']) ?>
            </div>
        </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <div class="info-box">
                    ...
                    <div class="info-value"><?= h($staff->full_name) ?></div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="info-box">
                    ...
                    <div class="info-value">
                        <?= $staff->hasValue('user') ? h($staff->user->email) : '-' ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-value"><?= $this->Number->format($staff->id) ?></div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-value"><?= h($staff->phone_number) ?></div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="info-box">
                    ...
                    <div class="info-value">
                        <span class="badge-red"><?= h($staff->position) ?></span>
                    </div>
                </div>
            </div>
        ...
        <div class="related-card">
            ...
            <?php if (!empty($staff->donation_histories)) : ?>
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            <?php foreach ($staff->donation_histories as $donationHistory) : ?>
                                <tr>
