...
.status-badge { padding:7px 13px; border-radius:20px; font-size:14px; font-weight:700; text-transform:capitalize; }
...
<div class="dashboard-wrapper">
    <aside class="sidebar">
        ...
        <?= $this->Html->link('📅 Appointments', ['controller'=>'Appointments','action'=>'index'], ['class'=>'active']) ?>
    ...
    <main class="main-content">
        <div class="topbar d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
            <div>
                <h4 class="mb-1">Appointment Management</h4>
                <p class="text-muted mb-0">Manage donor appointment bookings and approval status.</p>
            </div>
        ...
        <div class="page-card">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
                <div>
                    <h2 class="page-title mb-1">📅 Appointment List</h2>
                    <p class="text-muted page-subtitle mb-0">All donor appointment requests in RedConnect.</p>
                </div>

                <?= $this->Html->link('+ Add Appointment', ['action'=>'add'], ['class'=>'btn-red']) ?>
            </div>
                        ...
                        <?php foreach ($appointments as $appointment): ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?= $this->Html->link('View', ['action'=>'view',$appointment->id], ['class'=>'action-link view-btn']) ?>
                                    <?= $this->Html->link('Edit', ['action'=>'edit',$appointment->id], ['class'=>'action-link edit-btn']) ?>
                                    <?= $this->Form->postLink('Delete', ['action'=>'delete',$appointment->id], [
                                        'method'=>'delete',
